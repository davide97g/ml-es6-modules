...
let mouseClick = ({ x, y, shiftPressed }) => {
	...
	// store point
	data.push([ (x - master.WIDTH / 2) / master.ss, (y - master.HEIGHT / 2) / master.ss ]);
...
drawers.push(new drawer(svm_linear, document.getElementById('svm-linear-canvas'), { margin: 'soft' }));
drawers.push(new drawer(svm_poly, document.getElementById('svm-poly-canvas'), { margin: 'soft' }));
drawers.push(new drawer(svm_rbf, document.getElementById('svm-rbf-canvas'), { margin: 'soft' }));
drawers.push(new drawer(knn, document.getElementById('knn-canvas'), { margin: 'soft' }));
drawers.push(new drawer(rbf, document.getElementById('rbf-canvas'), { margin: 'soft' }));
drawers.push(new drawer(randf, document.getElementById('randf-canvas'), { margin: 'soft' }));
drawers.push(new drawer(logreg, document.getElementById('logreg-canvas'), { margin: 'soft' }));
drawers.push(new drawer(nn, document.getElementById('nn-canvas'), { margin: 'soft' }));
